...
function show2_show(partner_id, wg_params) {
   ...
   if (document.getElementById('2show_container') == null) {
        ...
        content_back.style.cssText = "display: block; border:none; z-index:65010; background:url('" + show2_domain + "/images/transparentbg.png'); position:fixed; width:100%; height:100%; padding:0px; margin:0px; left:" + scrollLeft + "px; top:" + scrollTop + "px;" + "bottom:0; right:0;";
	...
	var URL_iframe = show2_domain + "/picker/widget?" + params + "&amp;use_method=infront";
	if (((typeof _gaq  != 'undefined') && (typeof EnableAnalytics  != 'undefined') && (typeof TypeAnalytics  != 'undefined')) && ( EnableAnalytics && TypeAnalytics == 'classic' ))
	{
		_gaq.push(function() {
			var pageTracker = _gat._getTrackerByName();
			document.getElementById( "2show_iframe" ).src = pageTracker._getLinkerUrl( URL_iframe );
		});
	}
	else document.getElementById("2show_iframe").src = URL_iframe;
